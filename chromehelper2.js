var wall_proxy = "SOCKS 127.0.0.1:1080;";
...
var subnetIpRangeList = [0, 1, 167772160, 184549376, //10.0.0.0/8 
...
function isInSingleRange(ipRange, intIp) {
  if (hasOwnProperty.call(cnIp16Range, intIp >>> 6)) {
    for (var range = 1; range < 64; range *= 4) {
      ...
      if (hasOwnProperty.call(ipRange, master)) return intIp - master < ipRange[master];
    }
  } else {
...
function isInSubnetRange(ipRange, intIp) {
  for (var i = 0; i < 10; i += 2) {
    if (ipRange[i] <= intIp && intIp < ipRange[i + 1]) return true;
  }
}
...
function FindProxyForURL(url, host) {
  if (host == "localhost" || host == "127.0.0.1" || host == "ghelper.local" || shExpMatch(host, "192.168.*") || shExpMatch(host, "10.168.*") || shExpMatch(host, "*.21t.xyz") || shExpMatch(host, "*.tcpbbr.net") || shExpMatch(host, "tcpbbr.net") || shExpMatch(host, "*.pickdown.net") || shExpMatch(host, "pickdown.net") || shExpMatch(host, "*.onhop.net") || shExpMatch(host, "onhop.net") || shExpMatch(host, "*.copyplay.net") || shExpMatch(host, "*.chromehelper.net") || shExpMatch(host, "*.speedstunnel.com") || shExpMatch(host, "*.ghelper.org") || shExpMatch(host, "*.51netflix.com") || host == "chromehelper.net") {
    return "DIRECT";
  }
  if (host == "android.com" || shExpMatch(host, "*.android.com")) {
    return "HTTPS www.pickdown.net:1443;HTTPS hgc.tcpbbr.net:443;HTTPS www.51netflix.com:1443";
  }
